...
class DB {
    ...
    final public const DATABASE = 'query-1';
...
$DB -> table('users')
    ...
    -> join('countries', 'users.countries_id', 'countries.id')
    -> get();
...
$DB1 -> table('users')
    -> select('users.id', 'users.username', 'countries.name')
    -> leftJoin('countries', 'users.countries_id', 'countries.id')
    -> get();
...
$DB2 -> table('users')
    -> select('users.id', 'users.username', 'countries.name')
    -> rightJoin('countries', 'users.countries_id', 'countries.id')
    -> get();
